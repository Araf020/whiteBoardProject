      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          <ListItem key= "assign" disablePadding sx={{display: 'block'}}>
            ...
            onClick={() => {setOption('assign'); console.log("post clicked")} }>
              ...
              <ListItemText primary="Assign Instructor" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem key= "approve" disablePadding sx={{display: 'block'}}>
            <ListItemButton sx={{
              ...
              <ListItemIcon 
                ...
                onClick={() => {setOption('approve');console.log("approve clicked")}}
              >
                <AccountTreeRoundedIcon />
              </ListItemIcon>
              <ListItemText primary="Approve Enrollment" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
